      ...
      <tr className="border-b">
        ...
        <td className="relative px-4 py-3 flex items-center justify-center">
          ...
          <div
            ...
            className={`${
              !active && 'hidden'
            } absolute top-[52px] right-0 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow`}
          >
            <ul
            ...
            >
              ...
              <li>
                ...
                <button
                  ...
                  className="flex w-full items-center py-2 px-4 hover:bg-gray-200 text-red-500"
                >
                  <svg
                    className="w-4 h-4 mr-2"
                    viewBox="0 0 14 15"
