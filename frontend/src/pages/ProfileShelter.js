          ...
          <div className="border p-4 shadow-[2px_2px_2px_1px_#0004] hover:shadow-[2px_2px_2px_1px_#0006] rounded-lg hover:cursor-pointer bg-white col-span-2">
            <div className="mb-8">
              <h3 className="text-lg font-bold mb-2">
                Responded Vaccination Appointments
              </h3>
              {notifications.map((item) => (
                <div
                  key={item._id}
                  className="border grid grid-cols-[1fr,100px] border-purple-500 p-4 mb-4 rounded-lg shadow-lg bg-gradient-to-r from-purple-200 via-purple-300 to-purple-400 hover:from-purple-300 hover:via-purple-400 hover:to-purple-500 hover:shadow-xl transition duration-300 ease-in-out"
                >
                  <div>
                    <Link
                      to={item.link}
