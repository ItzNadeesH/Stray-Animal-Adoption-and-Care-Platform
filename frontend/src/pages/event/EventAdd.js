...
function EventAdd() {
   ...
   const handleAdd = async () => {
      ...
      if (!name || !description || !date || !start_time || !end_time || !location || !image) {
            ...
            <div className="w-full shadow-md shadow-neutral-300 m-auto p-4 bg-white">
               <div className="grid grid-cols-4 gap-4">
                  ...
                  <div>
                     ...
                     <input type="date" className="w-full p-2 text-sm border border-slate-300 shadow-tremor-card" onChange={(e) => setDate(e.target.value)} min={minDate} />
                  </div>
                  <div>
                     <div className="text-sm font-semibold leading-4 mb-2">Start Time</div>
                     <input type="time" className="w-full p-2 text-sm border border-slate-300 shadow-tremor-card" onChange={(e) => setStartTime(e.target.value)} />
                  </div>
                  <div>
                     <div className="text-sm font-semibold leading-4 mb-2">End Time</div>
                     <input type="time" className="w-full p-2 text-sm border border-slate-300 shadow-tremor-card" onChange={(e) => setEndTime(e.target.value)} />
                  </div>
                  <div>
