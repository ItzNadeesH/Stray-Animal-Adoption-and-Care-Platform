            ...
            {Object.keys(eventData).length > 0 && (
               <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                     ...
                     <input type="text" className="w-full p-2 text-sm border border-slate-300 shadow-tremor-card" value={eventData.start_time} disabled />
                  </div>
                  <div>
                     <div className="text-sm font-semibold leading-4 mb-2">End Time</div>
                     <input type="text" className="w-full p-2 text-sm border border-slate-300 shadow-tremor-card" value={eventData.end_time} disabled />
                  </div>
                  <div>
