         ...
         <div className="w-full shadow-md shadow-neutral-300 m-auto p-4 bg-white">
            <div className="grid grid-cols-3 gap-4">
               ...
               <div>
                  ...
                  <input min={minDate} onChange={(e) => setOnDate(e.target.value)} className="w-full p-2 text-sm border border-slate-300 shadow-tremor-card" id="onDate" type="date" placeholder="On Date" />
               </div>
            </div>
