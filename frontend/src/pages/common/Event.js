...
import { BiCalendar, BiCurrentLocation, BiTime } from "react-icons/bi";
                  ...
                  <div key={event._id} className="border p-4 rounded-lg bg-white shadow-[2px_2px_2px_1px_#0004]">
                     ...
                     <div className=" p-4 mb-4 rounded-lg bg-sky-200">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                           <div className="text-sm flex items-center"><BiCalendar className="mr-1 w-6" size={16} /> {event.date}</div>
                           <div className="text-sm flex items-center"><BiTime className="mr-1 w-6" size={16} /> {event.start_time} to {event.end_time}</div>
                           <div className="text-sm flex items-center"><BiCurrentLocation className="mr-1 w-6" size={16} /> {event.location}</div>
                        </div>
                     </div>
                     <div className="flex">
                        {(user && user?.role === 'User') ? (
