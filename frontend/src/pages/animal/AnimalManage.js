...
function AnimalManage ({ onSelect }) {
   ...
   return (
      <div className="p-10">
         ...
         <div className="flex space-x-3">
            <button onClick={() => onSelect('Add Animal')} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3 flex items-center"><HiPlus className="mr-3" /> Add Animal</button>
